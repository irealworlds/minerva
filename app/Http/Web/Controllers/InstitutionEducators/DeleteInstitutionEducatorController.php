...
namespace App\Http\Web\Controllers\InstitutionEducators;
...
#[Group(prefix: '/Institutions/Manage/{institution}/Educators/{educator}')]
final readonly class DeleteInstitutionEducatorController extends Controller
{
     ...
     */
    #[Delete('/', name: 'institutions.educators.delete')]
