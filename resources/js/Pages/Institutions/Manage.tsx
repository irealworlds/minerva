...
export default function Manage({ auth, institution, activeTab }: PageProps<{ institution: InstitutionViewModel, activeTab: string }>)
{
    let tabContent: JSX.Element;
    switch (activeTab.toLowerCase()) {
        case "general": {
            tabContent = <ManageInstitutionDetails user={auth.user} institution={institution} />;
            break;
        }
        default: {
            router.visit(route("institutions.show", {
