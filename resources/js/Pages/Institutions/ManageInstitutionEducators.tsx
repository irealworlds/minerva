...
import InstitutionEducatorsTable from '@/Pages/Institutions/Partials/Manage/Educators/InstitutionEducatorsTable';
...
import NoEducators from '@/Pages/Institutions/Partials/Manage/Educators/NoEducators';
...
import OutstandingInvitations from '@/Pages/Institutions/Partials/Manage/Educators/OutstandingInvitations';
import InviteEducatorDialog from '@/Pages/Institutions/Partials/Manage/Educators/InviteEducatorDialog';
import Paginator from '@/Components/Paginator';
import EducatorDetailsOverlay from '@/Pages/Institutions/Partials/Manage/Educators/EducatorDetailsOverlay';
...
export default function ManageInstitutionEducators({
    ...
    function sendInvitation() {
        sendCreationRequest(route('educator_invitations.create'));
    }
