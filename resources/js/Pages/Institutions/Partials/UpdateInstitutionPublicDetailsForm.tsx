...
export default function UpdateInstitutionPublicDetailsForm({ institution }: { institution: InstitutionViewModel }) {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('institutions.update.public', {
    ...
    useEffect(() => {
        console.debug("ffect", institution);
        setData("name", institution.name)
        setData("website", institution.website ?? "");
        console.debug(data, pictureInputPreview);
                    ...
                    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="col-span-full">
                            ...
                            <div className="mt-2 flex flex-wrap items-center gap-y-6 gap-x-3 mt-4">
                                {pictureInputPreview
                                    ? <img src={pictureInputPreview} className="size-12 rounded-full border" alt="Upload preview" />
                                    : <div
                                ...
                                {data.picture !== undefined &&
                                    <SecondaryButton type="button" onClick={() => updatePictureInputValue(undefined)}>
                                        Discard changes
                                    </SecondaryButton>
                                }
                                {data.picture !== null && institution.pictureUri !== null &&
                                    <DangerButton type="button" onClick={() => updatePictureInputValue(null)}>
                                        Clear
                                    </DangerButton>
                                }
