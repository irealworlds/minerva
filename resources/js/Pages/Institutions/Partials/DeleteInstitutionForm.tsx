      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Remove this institution and all associated information from the
            system.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-6">
            <div className="sm:col-span-4">
              <p className="text-sm mb-4">
                In order to confirm your intention to delete this institution
                and all associated information, please type{' '}
                <span className="font-semibold">"{institution.name}"</span> into
                the box below.
              </p>
