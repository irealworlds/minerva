...
interface DisciplineAssociationSelectorProps {
    onAdd: (association: InstitutionViewModel) => void;
    disabled?: boolean;
}

export default function DisciplineAssociationSelector({
    disabled,
    onAdd,
}: DisciplineAssociationSelectorProps) {
    ...
    function onChange(newValue: InstitutionViewModel) {
        onAdd(newValue);
        setQuery('');
    }
    ...
    return (
        <>
            <Combobox
                ...
                as="div"
                value={null}
                onChange={(newValue: InstitutionViewModel | null) => {
                    setQuery('');
                    if (newValue) {
                        onChange(newValue);
                    }
