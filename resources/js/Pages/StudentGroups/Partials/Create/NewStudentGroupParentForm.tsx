      ...
      <div className="space-y-12 sm:space-y-16">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-600">
            Every student group must be subordinated to either an institution or
            a student group and be integrated in its structure.
          </p>
          ...
          <div className="mt-10 space-y-8 border-b border-gray-900/10 pb-12 sm:space-y-0 sm:divide-y sm:divide-gray-900/10 sm:border-t sm:pb-0">
            ...
            <div className="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
              ...
              <div className="mt-2 sm:col-span-2 sm:mt-0">
                ...
                <InputError message={errors.parentType} className="mt-2" />
              </div>
            </div>
                ...
                <div className="mt-2 sm:col-span-2 sm:mt-0">
                  {data.parentType === 'institution' && (
                    <ParentInstitutionSelector
                      disabled={disabled}
                      value={data.parent as InstitutionViewModel}
                      onChange={value => {
                  ...
                  {data.parentType === 'studentGroup' && (
                    <ParentGroupSelector
                      disabled={disabled}
                      value={data.parent as StudentGroupViewModel}
                      onChange={value => {
                        setData('parent', value);
                      }}
                    />
