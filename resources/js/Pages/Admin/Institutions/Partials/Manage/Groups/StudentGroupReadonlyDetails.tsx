...
import StudentGroupDisciplinesList from '@/Pages/Admin/Institutions/Partials/Manage/Groups/StudentGroupDisciplinesList';
...
export default function StudentGroupReadonlyDetails({
    ...
    function deleteGroup(): void {
        ...
        destroy(route('admin.student_groups.delete', { group: group.id }), {
            preserveScroll: true,
            preserveState: false,
        });
    }
