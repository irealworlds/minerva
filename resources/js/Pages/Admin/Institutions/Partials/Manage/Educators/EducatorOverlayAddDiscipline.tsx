...
import StudentGroupSelector from '@/Pages/Admin/Institutions/Components/StudentGroupSelector';
import { FormEventHandler, useState } from 'react';
import { StudentGroupViewModel } from '@/types/view-models/student-group.view-model';
import StudentGroupDisciplinesSelector from '@/Pages/Admin/Institutions/Components/StudentGroupDisciplinesSelector';
...
export default function EducatorOverlayAddDiscipline({
    ...
    const submit: FormEventHandler = e => {
        post(
            route('admin.educators.disciplines.store', {
                educator: educatorId,
            })
        );
        e.preventDefault();
