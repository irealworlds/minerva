...
import EducatorOverlayReadonlyDetails from '@/Pages/Admin/Institutions/Partials/Manage/Educators/EducatorOverlayReadonlyDetails';
...
import EducatorOverlayAddDiscipline from '@/Pages/Admin/Institutions/Partials/Manage/Educators/EducatorOverlayAddDiscipline';
...
import EducatorOverlayAddRole from '@/Pages/Admin/Institutions/Partials/Manage/Educators/EducatorOverlayAddRole';
...
export default function EducatorDetailsOverlay({
    ...
    function removeEducatorFromInstitution() {
        ...
        router.delete(
            route('admin.institutions.educators.delete', {
