...
import { EducatorManagementContext } from '@/Pages/Admin/Institutions/Partials/Manage/Educators/EducatorDetailsOverlay';
...
export default function EducatorDetailsRoleEntry({
    ...
    function revokeRole() {
        ...
        router.visit(
            route('admin.institutions.educators.roles.delete', {
