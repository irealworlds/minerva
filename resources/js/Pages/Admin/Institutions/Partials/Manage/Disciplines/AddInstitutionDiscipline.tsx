import InstitutionDisciplineSelector from '@/Pages/Admin/Institutions/Components/InstitutionDisciplineSelector';
...
export default function AddInstitutionDiscipline({
    ...
    function submit(e: MouseEvent<HTMLButtonElement>): void {
        ...
        e.preventDefault();
        post(
            route('admin.institutions.show.disciplines.store', {
